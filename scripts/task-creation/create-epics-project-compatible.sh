...
*Created as part of Voice Transcription feature migration*"
    ...
    # Store the issue number based on epic num
    case $epic_num in
        1) EPIC1=$ISSUE_NUMBER ;;
        2) EPIC2=$ISSUE_NUMBER ;;
        3) EPIC3=$ISSUE_NUMBER ;;
        4) EPIC4=$ISSUE_NUMBER ;;
        5) EPIC5=$ISSUE_NUMBER ;;
    esac
...
echo ""
echo "📊 Created Epics:"
[ -n "$EPIC1" ] && echo "  - Epic 1: Issue #$EPIC1"
[ -n "$EPIC2" ] && echo "  - Epic 2: Issue #$EPIC2"
[ -n "$EPIC3" ] && echo "  - Epic 3: Issue #$EPIC3"
[ -n "$EPIC4" ] && echo "  - Epic 4: Issue #$EPIC4"
[ -n "$EPIC5" ] && echo "  - Epic 5: Issue #$EPIC5"
